...
${OBJECTDIR}/Database\ Connections/DBAdapter.o: Database\ Connections/DBAdapter.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Database\ Connections/DBAdapter.o Database\ Connections/DBAdapter.cpp
...
${OBJECTDIR}/Network\ Handler/NetworkHandler.o: Network\ Handler/NetworkHandler.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Network\ Handler/NetworkHandler.o Network\ Handler/NetworkHandler.cpp

${OBJECTDIR}/SoundController.o: SoundController.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SoundController.o SoundController.cpp
...
${OBJECTDIR}/Database\ Connections/DBAdapter_nomain.o: ${OBJECTDIR}/Database\ Connections/DBAdapter.o Database\ Connections/DBAdapter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Database\ Connections/DBAdapter_nomain.o Database\ Connections/DBAdapter.cpp;\
	else  \
...
${OBJECTDIR}/Logger/Logger_nomain.o: ${OBJECTDIR}/Logger/Logger.o Logger/Logger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Logger/Logger_nomain.o Logger/Logger.cpp;\
	else  \
...
${OBJECTDIR}/Network\ Handler/NetworkHandler_nomain.o: ${OBJECTDIR}/Network\ Handler/NetworkHandler.o Network\ Handler/NetworkHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Network\ Handler/NetworkHandler_nomain.o Network\ Handler/NetworkHandler.cpp;\
	else  \
...
${OBJECTDIR}/SoundController_nomain.o: ${OBJECTDIR}/SoundController.o SoundController.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SoundController_nomain.o SoundController.cpp;\
	else  \
