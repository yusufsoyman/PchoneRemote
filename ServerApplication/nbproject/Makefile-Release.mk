...
${OBJECTDIR}/include/XmlParser/XmlParser.o: include/XmlParser/XmlParser.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/XmlParser/XmlParser.o include/XmlParser/XmlParser.cpp
...
${TESTDIR}/tests/xmltest.o: tests/xmltest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/xmltest.o tests/xmltest.cpp
...
${OBJECTDIR}/include/XmlParser/XmlParser_nomain.o: ${OBJECTDIR}/include/XmlParser/XmlParser.o include/XmlParser/XmlParser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/XmlParser/XmlParser_nomain.o include/XmlParser/XmlParser.cpp;\
	else  \
