...
${OBJECTDIR}/include/ConfigReader/ConfigReader.o: include/ConfigReader/ConfigReader.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/ConfigReader/ConfigReader.o include/ConfigReader/ConfigReader.cpp
...
${OBJECTDIR}/include/Database\ Connections/DBAdapter.o: include/Database\ Connections/DBAdapter.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Database\ Connections/DBAdapter.o include/Database\ Connections/DBAdapter.cpp

${OBJECTDIR}/include/Logger/Logger.o: include/Logger/Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/include/Logger
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Logger/Logger.o include/Logger/Logger.cpp
...
${TESTDIR}/tests/dbtest.o: tests/dbtest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dbtest.o tests/dbtest.cpp
...
${OBJECTDIR}/include/ConfigReader/ConfigReader_nomain.o: ${OBJECTDIR}/include/ConfigReader/ConfigReader.o include/ConfigReader/ConfigReader.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/ConfigReader/ConfigReader_nomain.o include/ConfigReader/ConfigReader.cpp;\
	else  \
...
${OBJECTDIR}/include/Database\ Connections/DBAdapter_nomain.o: ${OBJECTDIR}/include/Database\ Connections/DBAdapter.o include/Database\ Connections/DBAdapter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Database\ Connections/DBAdapter_nomain.o include/Database\ Connections/DBAdapter.cpp;\
	else  \
...
${OBJECTDIR}/include/Logger/Logger_nomain.o: ${OBJECTDIR}/include/Logger/Logger.o include/Logger/Logger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Logger/Logger_nomain.o include/Logger/Logger.cpp;\
	else  \
...
${OBJECTDIR}/include/Network\ Handler/NetworkHandler_nomain.o: ${OBJECTDIR}/include/Network\ Handler/NetworkHandler.o include/Network\ Handler/NetworkHandler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/include/Network\ Handler/NetworkHandler_nomain.o include/Network\ Handler/NetworkHandler.cpp;\
	else  \
